...
if(isset($_POST['submit']))
{
  ...
  $discript=$_POST['discript'];
	...
	$cmd="insert into view_event(purpose,date,time,discript) values('$purpose','$date','$time','$discript')";
	// run your query
...
<form action="" method="post">
  ...
  <label for="text"><b>Discription :</b></label>
    ...
    <button type="submit" name="Login" value="submit" href="view_event.php"><b>submit</b></button>
  </div>
