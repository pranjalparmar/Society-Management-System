...
input[type=text], input[type=password],select,date {
  width: 100%;
  padding: 15px;
  margin: 5px 0 22px 0;
...
?>
<form action="insert_event.php" method="GET">
  <div class="container">
    <h1>Event Details</h1>
    ...
    <input type="date" placeholder="DD/MM/YYYY" name="edate" required>

	<br>
    <label for="discription"><b>Event Discription</b></label>
    <input type="text" placeholder="Enter Event discription" name="edis" required>
