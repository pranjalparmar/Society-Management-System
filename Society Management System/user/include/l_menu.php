...
<div class="topnav" id="myTopnav">
  ...
  <div class="dropdown">
    <button class="dropbtn" href="ucomplain.php">Manage Complain 
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="ucomplain.php">Make Complain</a>
      <a href="viewcomplain.php">View Complain</a>
      
    </div>
  </div> 
  <a href="#about" >Pay Maintanance</a>
  <a href="hallbook.php" >Book Event Hall</a>
